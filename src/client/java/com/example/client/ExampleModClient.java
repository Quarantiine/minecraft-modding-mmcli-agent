...
public class ExampleModClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		// Register cutout render layer for construction block to support transparent scaffolding textures
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.CONSTRUCTION_BLOCK, RenderLayer.getCutout());
