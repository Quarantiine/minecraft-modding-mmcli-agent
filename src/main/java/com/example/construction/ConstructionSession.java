...
public class ConstructionSession {
	...
	/**
	 * Creates a new ConstructionSession anchored at the specified world coordinate.
	 *
	...
	public ConstructionSession(
		...
		// Initialize construction tasks from sorted blueprint blocks
		List<BlueprintBlock> blueprintBlocks = blueprint.getBlocks();
